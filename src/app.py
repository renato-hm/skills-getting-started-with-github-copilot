...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and skills through soccer training and matches",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": []
    },
    "Basketball Club": {
        "description": "Improve shooting, passing, and defensive skills in a team setting",
